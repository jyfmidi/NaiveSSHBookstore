    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="manageBook.action">书籍管理<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <form class="navbar-form navbar-right" action = "addBook.action" method = "post">
                <div class="form-group">
                    <input type="text" placeholder="书名" class="form-control" name="title">
                </div>
                <div class="form-group">
                    <input type="number" placeholder="书号" class="form-control" name="isbn">
                </div>
                <div class="form-group">
                    <input type="text" placeholder="种类" class="form-control" name="category">
                </div>
                <div class="form-group">
                    <input type="number" placeholder="价格" class="form-control" name="price">
                </div>
                <div class="form-group">
                    <input type="text" placeholder="描述" class="form-control" name="profile">
                </div>
