...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            %>
            <ul class="nav nav-sidebar">
                <li class="active"><a href="queryUser.action">用户管理<span class="sr-only">(current)</span></a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <%
                Vector<UsersEntity> users = (Vector<UsersEntity>)request.getAttribute("userlist");
                int size = users.size();
                if (size > 0) {
            %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action = "deleteUser.action" method = "post">
                                <input type = "hidden" name = "username" value = <%= users.get(i).getUname() %> />
                        ...
                        <td>
                            <%
                                if(!session.getAttribute("username").equals(users.get(i).getUname())){
                            %>
                            <form action = "changeUser.action" method = "post">
                                <input type = "hidden" name = "username" value = <%= users.get(i).getUname() %> />
                                <input type = "submit" value = "权限修改" class="btn btn-primary"/>
                            </form>
                            <%
                                }
                            %>
