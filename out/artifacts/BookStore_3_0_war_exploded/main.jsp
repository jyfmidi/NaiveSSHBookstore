...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form class="navbar-form navbar-right" action="searchBook.action" method="post">
                <input type="text" class="form-control" placeholder="Search book..." name="content">
            </form>
        </div>
    </div>
</nav>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">推荐书籍</h1>

            <div class="row placeholders">
                <div class="col-xs-6 col-sm-3 placeholder">
                    <img data-src="/picture/The Man.jpg" class="img-responsive" alt="Generic placeholder thumbnail">
                    <h4>Label</h4>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><form action = "updateCart.action" method = "post" class="form-inline">
