    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <%
                ...
                {
            %>
            <h2 class="sub-header">购书书本统计</h2>
            <%
                Vector<BooksEntity> categorys = (Vector<BooksEntity>)request.getAttribute("categorylist");
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    %>
                    <tr>
                        <td><%= categorys.get(i).getTitle() %>&nbsp;</td>
                        <td><%= categorys.get(i).getIsbn() %>&nbsp;</td>
                        <td><%= times.get(i) %>&nbsp;</td>
