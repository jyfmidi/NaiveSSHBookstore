    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="navbar-form navbar-right">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        ...
                        <li><a href="StatDate.jsp">按日期</a></li>
                    </ul>
                </div>
            </div>
            <%
            ...
            <%
                ...
                {
            %>
            <h2 class="sub-header">用户购书统计</h2>
            <%
                Vector<UsersEntity> users = (Vector<UsersEntity>)request.getAttribute("userlist");
                Vector<Integer>times=(Vector<Integer>)request.getAttribute("timeslist");
                Vector<Integer>bookNumber=(Vector<Integer>)request.getAttribute("bookNumber");
                Vector<BigDecimal>price=(Vector<BigDecimal>)request.getAttribute("pricelist");
                int size = users.size();
                if (size > 0) {
            %>
